/**
 * Extension for checkoutwc woocommerce checkout page
 */
class TerminalCheckoutWCWoocommerce {
  /**
   * Constructor
   */
  constructor() {
  ...
  setCountryDefaultSelection() {
    ...
    // Trigger the event to update the styled select box
  ...
  initDefaultCities() {
    ...
    terminalCheckoutWC.passCitiesToShippingCity(
  ...
  setDefaultZipCode() {
    ...
    //get the element
    let zipCodeElement = this.$('input[name="shipping_postcode"]');
...
/**
 * Initialise TerminalCheckoutWCWoocommerce
 */
new TerminalCheckoutWCWoocommerce();
